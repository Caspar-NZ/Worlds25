...
@TeleOp(name = "ZZColourConfiguration", group = "Calibration")
public class ZZColourConfiguration extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        crf.setPin0Digital(ColorRangefinder.DigitalMode.HSV, 60 / 360.0 * 255, 77.1 / 360.0 * 255); // yellow updated
